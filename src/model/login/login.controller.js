...
var LoginController = exports.LoginController = function () {
    ...
    var LoginController = _classThis = /** @class */ (function () {
        function LoginController_1(service) {
            this.service = (__runInitializers(this, _instanceExtraInitializers), void 0);
            this.service = service;
        }
        LoginController_1.prototype.login = function (payload) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.service.login(payload)];
                });
            });
        };
    ...
    (function () {
        _login_decorators = [(0, common_1.Post)('login'), (0, swagger_1.ApiTags)('/login')];
